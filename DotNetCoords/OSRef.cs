...
namespace DotNetCoords
{
  ...
  public class OSRef : CoordinateSystem 
  {
    ...
    {
      int e = (int)Math.Floor((_easting - (100000 * HundredKmEast())));
      int n = (int)Math.Floor((_northing - (100000 * HundredKmNorth())));
    ...
    {
      int e = (int)Math.Floor((_easting - (100000 * HundredKmEast())) / 100);
      int n = (int)Math.Floor((_northing - (100000 * HundredKmNorth())) / 100);
    ...
    public override LatLng ToLatLng() 
    {
      ...
      double n = (a - b) / (a + b);
      double m;
      double phiPrime = ((N - n0) / (a * osgbF0)) + phi0;
      do {
        m = (b * osgbF0)
