  ...
  public class MGRSRef : CoordinateSystem 
  {
    ...
    */
    ...
    public UTMRef ToUTMRef() 
    {
      ...
      Get_Grid_Values(out ltr2LowValue, out ltr2HighValue, out falseNorthing);
      ...
      * Also check that the third letter is valid */
      ...
      double gridNorthing = offsetNorthing * 100000.0 + falseNorthing;
      ...
      double minNorthing;
      Get_Latitude_Band_Min_Northing(UtmZoneChar, out minNorthing);
